...
var Injector = function(modules, parent) {
  ...
  var createChild = function(modules, providersFromParent) {
    ...
    return new Injector(modules, instances.injector);
  };
  ...
  modules.forEach(function(module) {
    ...
    if (module instanceof Module) {
      ...
      if (module.public && !module.private) {
        module = module.public;
      } else if (module.public && module.private) {
        var privateInjector = createChild([module.private, module.public]);
        var getFromPrivateInjector = function(name) {
          return privateInjector.get(name);
        };

        return Object.keys(module.public).forEach(function(key) {
          providers[key] = [getFromPrivateInjector, key, 'private'];
        });
      }
